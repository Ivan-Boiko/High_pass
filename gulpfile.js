...
watch('src/scss/vendor/*.css', buildResources)
...
exports.build = series  (clean, defaultExport,  htmlMinify, buildStyles, scripts, buildResources , images, svgSprites, watchFiles)
